...
class DaySchedule extends StatelessWidget {
  ...
  const DaySchedule({this.lessons, Key? key}) : super(key: key);
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: item.subjectType == 'Ćwiczenia'
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  '${item.subjectType}: ${convertToHoursFormat(item.startTime)} - ${convertToHoursFormat(item.endTime)}',
                ),
